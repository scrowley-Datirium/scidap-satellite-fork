...
start-cluster-api $OUTPUT_DIR $SCRIPT_DIR $TMP_TOIL_DIR $ENV_FILE_PATH $BATCH_SYSTEM_TOIL $NJS_CLIENT_PORT $SINGULARITY_TMP_DIR $CWL_SINGULARITY_DIR $SATELLITE_ROOT $NUM_CPUS $MAX_MEM 